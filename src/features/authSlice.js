...
const initialState = {
    ...
    loginDetails: JSON.parse(localStorage.getItem("loginDetails"))?JSON.parse(localStorage.getItem("loginDetails")):[],
    isAlert: false,
    AlertMessage: "",
    AlertStyle: "red-600"
}

export const signUp = createAsyncThunk("signup", async (details, { rejectWithValue }) => {
    try {
...
export const logIn = createAsyncThunk("login", async (details, { rejectWithValue }) => {
    try {
